                ...
                <v-row>
                    <v-col xs="12" md="5">
                        <base-subheading class="mb-3"
                            >Suscripción</base-subheading
                        >
                        <p>
                            Ingrese su dirección de correo electrónico para
                            suscribirse a este portafolio y recibir
                            notificaciones de nuevas publicaciones de servicios
                        ...
                        <v-list class="transparent">
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    ...
                                    >
                                    <v-list-item-subtitle
                                        >212-789-1234</v-list-item-subtitle
                                    >
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
