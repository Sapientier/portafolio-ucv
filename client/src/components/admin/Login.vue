                        ...
                        <v-card-actions>
                            <v-btn icon>
                                <v-tooltip bottom>
                                    ...
                                    <span
                                        >Las credenciales les serán enviadas por
                                        correo, por favor contacte con el
                                        administrador.</span
                                    >
                                </v-tooltip>
                            </v-btn>
...
export default {
    data: () => ({
        ...
        passwordRules: [
            ...
            (v) =>
                v.length <= 20 ||
                "La contraseña debe ser menor a 20 caracteres",
        ],
        emailRules: [
    ...
    methods: {
        async login() {
            ...
            try {
                ...
                this.$store.dispatch(
                    "setUserNumNoti",
                    response.data.user.numNoti
                );
                this.$store.dispatch(
                    "setschoolUser",
                    response.data.user.schoolUser
                );
                this.$store.dispatch(
                    "setinstituteUser",
                    response.data.user.instituteUser
                );
                this.$router.push({
                    name: "UserProfile",
                });
